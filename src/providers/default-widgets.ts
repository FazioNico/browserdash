export const defaultWidgetsSetting = [
  {displayName: 'Meteo', name: 'meteo', active: false, enabled: true},
  {displayName: 'Link btn list', name: 'btn-list', active: false, enabled: false},
  {displayName: 'Todos list', name: 'todos-list', active: false, enabled: false},
